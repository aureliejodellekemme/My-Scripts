...
def main():
    ...
    file_path = 'C:/Users/HP ELITEBOOK/Documents/VIEBEG_MEDICAL/research/data/manual/MOH_OPD_HOSP/New Data/Mental Health Diseases.xlsx'
    ...
    from clean_chronic_diseases import consolidate_chronic_diseases
    disease_data = consolidate_chronic_diseases(xls_obj,'20')
    ...
    from clean_chronic_diseases import disease_count
    moh_data1=disease_count(moh_data,'20')
...
if __name__ == "__main__":
    moh_data2 = main()
    moh_data2.to_csv('C:/Users/HP ELITEBOOK/Documents/VIEBEG_MEDICAL/research/data/manual/Diseases/Mental-health.csv',index=False)
